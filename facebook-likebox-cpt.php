...
if ( ! class_exists( 'Fb_Likebox_Shortcode_CPT' ) ) {
	...
	class Fb_Likebox_Shortcode_CPT {
		...
		public function _fb_likebox_doc_menu() {
			...
			$featured_plugin_menu = add_submenu_page( 'edit.php?post_type='.FLWS_PLUGIN_SLUG, __( 'Free Plugins', 'fblike_txt_dm' ), __( 'Free Plugins', 'fblike_txt_dm' ), 'administrator', 'sr-featured-page', array( $this, '_fb_featured_page') );
		}		
