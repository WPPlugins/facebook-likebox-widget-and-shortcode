...
wp_enqueue_style('awl-bootstrap-css', FLWS_PLUGIN_URL .'css/bootstrap.css');
wp_enqueue_script('awl-bootstrap-js', FLWS_PLUGIN_URL .'js/bootstrap.js', array('jquery'), '' , true);
wp_enqueue_style('thickbox');
wp_enqueue_style('fp-bootstrap-css', FLWS_PLUGIN_URL.'featured-plugins/css/bootstrap.css');
wp_enqueue_style('fp-smartech-css', FLWS_PLUGIN_URL.'featured-plugins/css/smartech.css');
wp_enqueue_style('fp-feature-plugins', FLWS_PLUGIN_URL.'featured-plugins/css/feature-plugins.css');	
wp_enqueue_script('jquery');
wp_enqueue_script('fp-media-uploads',FLWS_PLUGIN_URL.'js/featured-plugins/acl-media-upload-script.js',array('media-upload','thickbox','jquery')); 
wp_enqueue_script('fp-bootstrap-min-js',FLWS_PLUGIN_URL.'js/featured-plugins/bootstrap.min.js');
								...
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12 text-center custom-buy-button">
											<a href="http://awplife.com/plugins/" target="_blank" class="btn btn-info btn-circle btn-xl"><i class=""></i> Buy Now</a>
										</div>
									</div>
									<hr>
								</div>
