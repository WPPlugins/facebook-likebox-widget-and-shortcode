...
Tags: facebook, facebook likebox, facebook likebox plugin, facebook widget, facebook plugin
...
A very easy and simple Facebook Likebox Widget & Shortcode Plugin for WordPress blog sites.
...
* [Media Slider](https://wordpress.org/plugins/media-slider/ "Best Media Slider") - Fully Responsive Media Slider For Wordpress ,You can Show videos And images in the .
...
**Buy Premium Plugin - <a href="http://awplife.com/product/media-slider-premium/">Click Here</a>**
...
**Buy Premium Plugin - <a href="http://awplife.com/product/weather-effect-premium/">Click Here</a>**
...
Now drag n drop the widget in available widget areas into your theme.
...
== Changelog ==
Feature Enhancements: Version 0.4.9
* Additional changes: None
* Bug fix: None

Feature Enhancements: Version 0.4.8
* Additional changes: None
* Bug fix: None

Feature Enhancements: Version 0.4.7
* Additional changes: None
* Bug fix: None

Feature Enhancements: Version 0.4.6
* Additional changes: None
* Bug fix: None

Feature Enhancements: Version 0.4.5
* Additional changes: New update
* Bug fix: None

Feature Enhancements: Version 0.4.4
* Additional changes: New update
* Bug fix: None

Feature Enhancements: Version 0.4.3
* Additional changes: New update
* Bug fix: None
...
* Additional changes: Added Shortcode feature
* Bug fix: yes
...
* Additional changes: Compatibility test
...
* Additional changes: compatible for new version of WordPress 
